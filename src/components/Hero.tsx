...
import { ArrowRight, Mail, Volume2, Square, Printer } from 'lucide-react';
...
export default function Hero() {
  ...
  const handleToggleVoice = () => {
    const text = t(
      'voice.hero_intro',
      'Hi, I am Arunava Chandan Roy, a Business Intelligence and Data Analyst. I specialize in turning data into insight, strategy, and measurable decisions.'
    );
    toggle(text);
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full text-center lg:text-left flex flex-col lg:flex-row items-center">
        ...
        >
          ...
          <div className="print-profile-pic-mobile lg:hidden relative w-48 h-48 sm:w-56 sm:h-56 rounded-full p-2 glass-card overflow-hidden shadow-[0_0_30px_rgba(6,182,212,0.2)] mb-8">
            ...
            <img
              ...
              onError={(e) => {
                ...
                target.src =
                  'https://ui-avatars.com/api/?name=Arunava+Roy&size=512&background=0284c7&color=fff';
              }}
            />
          </div>
          ...
          >
            {t(
              'hero.description',
              'Turning data into insight, strategy, and measurable decisions.'
            )}
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">
                {t('hero.download_cv', 'View / Print CV')}
              </span>
            </motion.a>
          </motion.div>
        </motion.div>
